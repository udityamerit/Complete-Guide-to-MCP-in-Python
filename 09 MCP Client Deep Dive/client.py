...
server_params = StdioServerParameters(
    command="uv",
    args=["--directory", "C:\\Users\\Uditya\\Documents\\Udemy-Courses\\06 Complete Guide to MCP in Python\\Complete Guide to MCP in Python\\09 MCP Client Deep Dive", "run", "server.py"],  # Optional command line arguments
)
